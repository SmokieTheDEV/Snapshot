...
module.exports = class BotInfoCommand extends Command {
  ...
  run(message) {
    ...
    const embed = new MessageEmbed()
      .setTitle('Snapshot\'s Bot Information')
      .setDescription(oneLine`
        Snapshot is an open source, fully customizable Discord bot that is constantly growing.
      ...
      .setImage('https://cdn.discordapp.com/attachments/761614436003741737/761859458678390784/addd.PNG')
